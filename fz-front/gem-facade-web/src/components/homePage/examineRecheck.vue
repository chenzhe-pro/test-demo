...
<template>
    <div class="strategy childTable targetFill">
      <div class="top_box" style="height: auto;">
        ...
        <div class="p20">
          ...
          <el-table class="plan_map" height="100%" :data="tableData" border style="width: 100%;">
            <el-table-column prop="target" align="center" label="绩效数据" width="220"></el-table-column>
            ...
            <el-table-column prop="GS" align="center" label="指标名称" width="280">
            </el-table-column>
            <el-table-column prop="planSteps" align="center" label="数据公式" width="280">
            </el-table-column>
            <el-table-column prop="charge" align="center" label="填报人" width="100">
            </el-table-column>
            <el-table-column prop="charge" align="center" label="审核人" width="100">
            </el-table-column>
            <el-table-column prop="charge" align="center" label="实际值" width="100">
            </el-table-column>

            <el-table-column prop="planSteps" align="center" label="操作" >
              <template scope="scope">
      ...
      <el-dialog v-model="show_modal" size="tiny">
        <span slot="title">
          <span style="font-weight: bold">填报实际值</span>
        </span>
        <div class="dialog_title_line"></div>
        <div class="mt10 mb10">
          <span class="gray-text">绩效数据：</span>
          <span class="">产品合格数</span>
        </div>
        <div class="mt10 mb10">
          <span class="gray-text">来源：</span>
          <span class="">2017年01月陈嘉杰考核表</span>
        </div>
        <div class="mt10 mb10">
          <span class="gray-text">指标名称：</span>
          <span class="">产品合格率</span>
        </div>
        <div class="mt10 mb20 pb20" style="border-bottom: 1px solid #D9D9D9">
          <span class="gray-text">数据公式：</span>
          <span class="">产品合格数/产品总数*100%</span>
        </div>
        <el-form ref="form" :model="form" :rules="rules"  label-width="78px" label-position="right">
          <el-form-item label="实际值：" prop="actualValue">
            <el-input v-model="form.actualValue"  placeholder="请输入实际值"></el-input>
          </el-form-item>
        </el-form>
        <div class="mt20 mb10">
          <span class="gray-text">是否为当期绩效最终数据：</span>
          <el-radio-group v-model="form.finalVal">
    ...
    module.exports = {
      data:function () {
        return {
          ...
          rules:{
            actualValue: [
              {required: true, message: '请填写实际值', trigger: 'blur'}
            ],
          }
        }
      },
