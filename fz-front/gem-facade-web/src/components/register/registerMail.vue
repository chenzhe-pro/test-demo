  ...
  <div class="wrapper">
    <div class="login_box register">
      ...
      <el-form :model="registerForm" :rules="ruleInline" ref="registerForm">
        ...
        <el-form-item prop="mail" class="login_item" >
        <el-input v-model="registerForm.mail"  placeholder="邮箱地址" @blur="checkMail"></el-input>
      </el-form-item>
        <el-form-item prop="emailCount" class="login_item" >
          <el-col :span="14">
            <el-input v-model="registerForm.emailCount"  placeholder="验证码" ></el-input>
          </el-col>
          <el-col :span="10" class="pl20">
            <el-button v-if="!Countdown" class="login_btn" @click="sendEmail()" type="primary" :disabled="disSendBtn">发送验证码</el-button>
        ...
        <el-form-item prop="agree" class="login_item" >
      ...
      <div class="login_item ">
        <el-button class="login_btn" @click="register()" type="primary" :disabled="disRegister">注册</el-button>
      </div>
      <div class="login_item clearfix">
        <a href="#/registerPhone" class="fl blue_jump">使用手机注册</a>
...
//          agree: [
//            {required: true, type:'boolean', message: '请阅读用户协议', trigger: 'click'},
//          ]
        }
      }
    },
    computed:{
      disRegister:function () {
        if(this.registerForm.enterpriseName&&this.registerForm.mail&&
          this.registerForm.password&&this.registerForm.emailCount&&this.registerForm.checked){
          return false;
        }else{
          return true;
        }
    ...
    methods: {
      ...
      checkMail:function () {
        ...
        _com.$http.post(common.projectPath +'hasReg?registerName='+_com.registerForm.mail,{
        }).then(function (data) {
          data = data.body;
          if(data.code=='SUCCESS'){
            _com.$refs.registerForm.validateField('mail',function (valid){
              if(!valid){
...
//        })
      ...
      sendEmail:function () {
        var _com = this;
//        if(_com.registerForm.mail.valid){
          _com.$http.get(common.projectPath+'sendEmail',{
          params:{
            toEmail:_com.registerForm.mail
          }
          }).then(function (data) {
            data = data.body;
            if(data.code=='SUCCESS'){
      ...
      register: function () {
        var _com = this,
          ...
          vo = {
            ...
            emailCount:_com.registerForm.emailCount
          };
          console.log()
