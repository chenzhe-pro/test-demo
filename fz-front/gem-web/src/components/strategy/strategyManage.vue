  ...
  <div class="wrapper">
    ...
    <div class="content_wrapper roleManage ivu-article">
      <div class="content_head clearfix">
        <content_head icon-class="fa fa-crosshairs" title="策略管理" show-filter="true" :reload-function="getDataList">
      ...
      <div class="content_content clearfix">
        <el-table border :content="self" :data="objData">
          ...
          <el-table-column label="指标" align="center" prop="indicatorName">
          </el-table-column>
        ...
        <filter_form :filter-function="getDataList">
        </filter_form>
      </div>
      <!--编辑-->
      <el-dialog v-model="modalObj" :title="formTitle">
        <el-form ref="objForm" :model="objForm" label-width="80px" label-position="right" :rules="ruleValidate">
          ...
          <el-form-item label="指标" prop="indicatorId">
            <el-select style="width: 100%;"  v-model="objForm.indicatorId" size="small" filterable remote
  ...
  module.exports = {
    ...
    methods: {
      ...
      getIndicatorList: function (name) {
        ...
        _com.$http.get(common.projectPath + 'indicator/indicatormethod/selectIndicatorByName',{
          params:{
...
//            _com.$refs['objForm'].resetFields();
      ...
      getDataList: function (filter) {
        ...
        _com.$http.post(common.projectPath + 'indicator/indicatormethod/pageList',data,{
        }).then(function (data) {
          data = data.body;
...
//        });
      ...
      edit: function (index, row) {
        var _com = this,
          ...
          url = 'indicator/indicatormethod/detail/' + id;
...
//            _com.modalObj = true;
      ...
      saveObj: function (formName) {
        ...
        _com.$refs[formName].validate(function (valid) {
          if (valid) {//验证通过
            var data = {
                indicatorId:_com.objForm.indicatorId,
                name: _com.objForm.name,
                remark: _com.objForm.remark,
                status: _com.objForm.status?'Y':'N',
            };
            if (_com.formTitle === '新增策略信息') {
              url = 'indicator/indicatormethod/save';
            } else if(_com.formTitle === '编辑策略信息') {
              data.id = _com.objForm.id;
              url = 'indicator/indicatormethod/update';
            }
