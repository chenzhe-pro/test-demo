  ...
  <div class="wrapper">
    ...
    <div class="content_wrapper basicManage ivu-article">
      <div class="content_head clearfix">
        <content_head icon-class="fa fa-briefcase" title="标签资料管理" :reload-function="getAllDatas">
  ...
  module.exports = {
    ...
    methods: {
      ...
      getAllDatas: function () {
        ...
        _com.$http.post(common.projectPath + 'sys/basicdata/listTree/label/labelType',data,{
        }).then(function (data) {
          data = data.body;
          if (data.code=='SUCCESS') {
