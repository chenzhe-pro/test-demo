<template>
  <div class="wrapper">
    <page-head></page-head>
    <page-menu></page-menu>
    <div class="content_wrapper basicManage menuManage ivu-article">
      <div class="content_head clearfix">
        <content_head icon-class="fa fa-briefcase" title="编码后缀资料管理" :reload-function="getAllDatas">
  ...
  module.exports = {
    ...
    methods: {
      ...
      getAllDatas: function () {
        ...
        _com.$http.post(common.projectPath + 'sys/basicdata/listTree/codeRule/codeRuleType',data,{
        }).then(function (data) {
          data = data.body;
          if (data.code=='SUCCESS') {
