  ...
  <div class="wrapper">
    ...
    <div class="content_wrapper basicManage menuManage ivu-article">
      <div class="content_head clearfix">
        <content_head icon-class="fa fa-briefcase" title="提醒类型资料管理" :reload-function="getAllDatas">
  ...
  module.exports = {
    ...
    methods: {
      ...
      getAllDatas: function () {
        ...
        _com.$http.post(common.projectPath + 'sys/basicdata/listTree/Remind/RemindType',data,{
        }).then(function (data) {
          data = data.body;
          if (data.code=='SUCCESS') {
